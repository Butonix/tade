...
from tade.views import stories, account, tags, stats, moderation
...
from tade.webmention import webmention_endpoint
...
handler400 = "tade.urls.response_400_handler"
handler403 = "tade.urls.response_403_handler"
handler404 = "tade.urls.response_404_handler"
handler500 = "tade.urls.response_500_handler"
