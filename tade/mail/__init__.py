...
from tade.models import Story, User, Comment, Tag, ExactTagFilter, DomainFilter
from tade.markdown import Textractor

logger = logging.getLogger("tade")
...
def post_receive(data: typing.Union[str, bytes], user=None) -> str:
    ...
    if not user.has_perm("tade.add_comment") or not user.has_perm("tade.add_story"):
        EmailMessage(
